...
constexpr auto qt_meta_stringdata_CLASSCallManagerENDCLASS = QtMocHelpers::stringData(
    "CallManager",
    "onCallResponse",
    "",
    "QNetworkReply*",
...
void CallManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onCallResponse((*reinterpret_cast< std::add_pointer_t<QNetworkReply*>>(_a[1]))); break;
        default: ;
        }
